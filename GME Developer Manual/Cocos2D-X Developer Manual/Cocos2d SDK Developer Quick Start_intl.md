...
Thank you for using Tencent Cloud Game Multimedia Engine SDK. This document provides an overview that makes it easy for Cocos2D developers to debug and integrate the APIs for Game Multimedia Engine (GME).
...
This document only provides the most important APIs to help you get started with GME. For more APIs, please see [API Documentation](../Cocos2D-X%20Developer%20Manual/Cocos2d%20SDK%20Developer%20Manual_intl.md).
