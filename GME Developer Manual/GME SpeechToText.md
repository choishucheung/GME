...
廣東話 (香港)						|yue-Hant-HK		|中文，广东话（繁体，香港）
日本語（日本）						|ja-JP				|日本（日本）
普通話 (香港)						|cmn-Hans-HK		|中文，普通话（简体，香港）
...
English (United States)				|en-US				|美国英语）
...
Español (Honduras)					|es-HN				|西班牙文（洪都拉斯）
Español (México)					|es-MX				|西班牙语
...
Filipino (Pilipinas)					|fil-PH				|菲律宾人（菲律宾）
...
ಕನ್ನಡ (ಭಾರತ)						|kn-IN				|卡纳达（印度）
ភាសាខ្មែរ (កម្ពុជា)						|km-KH				|高棉（柬埔寨）
ລາວ (ລາວ)							|lo-LA				|老挝（老挝）
